...
import { FlowDetailSchema, type FlowDetail } from '@shared/validation/steps.schema'
...
// Detalle de un flow (tipado y validado)
export const flowDetail: FlowDetail = FlowDetailSchema.parse({
  ...
  steps: [
    ...
    { id: 'Q15', type: 'Question', text: 'Is the ramp rise > 6\"?', yesNext: 'Q16', noNext: 'Q17' },
    {
      id: 'Q16',
      type: 'Question',
    ...
    { id: 'END', type: 'End', message: 'Audit completed 🎉. Please submit your results.' },
  ],
})

// Colección de flows con steps (modo cold/all)
export const allFlows: { flows: FlowDetail[] } = {
  flows: [
    {
      flowId: 'RampFlow',
      version: 'v1.0',
